const langArr = {
    ...
    "text_hello" : {
        ...
        "eng": "Popular questions",
    },
    "text_hello1": {
        "ru": "В: Как происходит оформления заказа? Что для этого нужно?",
        "eng": "Q: How is ordering done? What is needed for this?",
    },
    "text_hello2": {
        "ru": "О: Оформления заказа происходит на сайте в разделе Lineage2 ,вы выбераете в поиске нужный сервер,\n"+
            "способ оплаты ,указываете электронную почту и ник персонажа. Для вашего удобства используется множиство различных\n" +
            "платёжных систем.",
    ...
    "text_hello4": {
        "ru": "О: Мы работаем каждый день над тем что бы , упростить вашу игру. Вы можете обратиться к нашему оператору ,\n" +
            "в любой удобный способ и узнать о наличии нужного предмета .\n" +
            "Наши специалисты , займутся поиском подходящего для Вас предмета, персонажа , эпика или оружия +16, но это может занять больше времени",
        "eng": "A: We work every day to make your game easier. You can select the desired server and contact the operator, in any convenient way, and find out if the product you need is in stock.\n" +
            "Our experts will look for the right item, character, equipment or gun +16 for you, but this may take longer,",
    },
    "text_hello5": {
...
function changeLanguage() {
    ...
    document.querySelector(".menu_3").innerHTML = langArr["text_menu2"][hash];
    document.querySelector(".menu_4").innerHTML = langArr["text_menu3"][hash];
    document.querySelector(".menu_5").innerHTML = langArr["text_menu4"][hash];
